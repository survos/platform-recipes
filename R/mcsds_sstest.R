...
# API call to assignments end point. Support function arguments are jobId, projectCode, waveId and maxPerPage
mcsds <- assignments()

mcsds <- as.data.frame(mcsds)
...
mcsds <- subset(mcsds, assignment_status_code == "Submitted" | assignment_status_code == "Approved")

# SCRIPT STOPS HERE AS NO FIELDS q1:q33 ARE RETURNED VIA THE API WITH ANY KNOWN JOBID
